define(['models/character','collections/characters'],function(Character, Characters) {

  return describe("CharacterList (List of characters in order or initiative)", function() {
